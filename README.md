...
```text
https://demonrider0.github.io/Double-Sided-Cards/manifest.json?v=39
```
...
Na versao `0.2.39`, o botao `Criar tabuleiro padrao` voltou temporariamente para gerar um novo backup pelo localhost. Em GitHub Pages ele nao salva arquivos novos, entao o fluxo publico continua sendo commitar o `assets/scene-preset.json` pronto e usar apenas `Restaurar tabuleiro padrao` dentro do Owlbear.
...
```text
http://localhost:5180/manifest.json?v=39
```
